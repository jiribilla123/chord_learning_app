...
# Personal message
st.divider()
st.markdown("Thanks for visiting 😀 I'm working on further updates including: <ul><li>Design upgrades</li> <li>More chord variations</li> <li>Chord inversions</li><li>and more!</li></ul><br> With love ♥️🎵 <br> Jaime",
